...
extern struct binSemaphore bsemaphores[MAX_BSEM];
...
enum threadstate { TUNUSED, TUSED, TSLEEPING, TRUNNABLE, TRUNNING, TZOMBIE, DYING};
...
struct thread {
  ...
  int xstate;
  uint64 kstack;              //Thread stack pointer 
