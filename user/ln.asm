...
main(int argc, char *argv[])
{
  ...
  14:	95058593          	addi	a1,a1,-1712 # 960 <csem_up+0x48>
  18:	4509                	li	a0,2
  ...
  50:	92c58593          	addi	a1,a1,-1748 # 978 <csem_up+0x60>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 410:	58c50513          	addi	a0,a0,1420 # 998 <digits>
 414:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4dc:	4c0b8b93          	addi	s7,s7,1216 # 998 <digits>
 ...
 61c:	37890913          	addi	s2,s2,888 # 990 <csem_up+0x78>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e4:	2d07b783          	ld	a5,720(a5) # 9b0 <freep>
 ...
 712:	00e6ea63          	bltu	a3,a4,726 <free+0x50>
{
 ...
 754:	26f73023          	sd	a5,608(a4) # 9b0 <freep>
}
 758:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 786:	22e53503          	ld	a0,558(a0) # 9b0 <freep>
 ...
 7ae:	20690913          	addi	s2,s2,518 # 9b0 <freep>
  if(p == (char*)-1)
 7b2:	5afd                	li	s5,-1
 7b4:	a895                	j	828 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7b6:	00000797          	auipc	a5,0x0
 7ba:	20278793          	addi	a5,a5,514 # 9b8 <base>
 7be:	00000717          	auipc	a4,0x0
 7c2:	1ef73923          	sd	a5,498(a4) # 9b0 <freep>
 7c6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ea:	1ca73523          	sd	a0,458(a4) # 9b0 <freep>
      return (void*)(p + 1);
...
int csem_alloc(struct counting_semaphore *sem, int initial_value){
 ...
 858:	b52080e7          	jalr	-1198(ra) # 3a6 <bsem_alloc>
 85c:	c088                	sw	a0,0(s1)
    sem->binary_semaphore2 = bsem_alloc();
 85e:	00000097          	auipc	ra,0x0
 862:	b48080e7          	jalr	-1208(ra) # 3a6 <bsem_alloc>
 866:	87aa                	mv	a5,a0
 868:	c0c8                	sw	a0,4(s1)
    if(sem->binary_semaphore1 == -1 || sem->binary_semaphore2 == -1)
 86a:	4088                	lw	a0,0(s1)
 86c:	577d                	li	a4,-1
 86e:	00e50963          	beq	a0,a4,880 <csem_alloc+0x3c>
 872:	02e78363          	beq	a5,a4,898 <csem_alloc+0x54>
        return -1;
    if(initial_value == 0)
 876:	00090b63          	beqz	s2,88c <csem_alloc+0x48>
        bsem_down(sem->binary_semaphore2);
    sem->value = initial_value;
 87a:	0124a423          	sw	s2,8(s1)
    return 0;
 87e:	4501                	li	a0,0
}
 ...
 892:	b28080e7          	jalr	-1240(ra) # 3b6 <bsem_down>
 896:	b7d5                	j	87a <csem_alloc+0x36>
        return -1;
 898:	853e                	mv	a0,a5
 89a:	b7dd                	j	880 <csem_alloc+0x3c>

000000000000089c <csem_free>:
...
void csem_free(struct counting_semaphore *sem){
 ...
 8ae:	b04080e7          	jalr	-1276(ra) # 3ae <bsem_free>
    bsem_free(sem->binary_semaphore2);
 8b2:	40c8                	lw	a0,4(s1)
 8b4:	00000097          	auipc	ra,0x0
 8b8:	afa080e7          	jalr	-1286(ra) # 3ae <bsem_free>
    sem->value = 0;
 8bc:	0004a423          	sw	zero,8(s1)
}
...
void csem_down(struct counting_semaphore *sem){
 ...
 8dc:	ade080e7          	jalr	-1314(ra) # 3b6 <bsem_down>
    bsem_down(sem->binary_semaphore1);
 8e0:	4088                	lw	a0,0(s1)
 8e2:	00000097          	auipc	ra,0x0
 8e6:	ad4080e7          	jalr	-1324(ra) # 3b6 <bsem_down>
    sem->value--;
 8ea:	449c                	lw	a5,8(s1)
 8ec:	37fd                	addiw	a5,a5,-1
 8ee:	0007871b          	sext.w	a4,a5
 8f2:	c49c                	sw	a5,8(s1)
    if(sem->value > 0)
 8f4:	00e04c63          	bgtz	a4,90c <csem_down+0x42>
        bsem_up(sem->binary_semaphore2);
    bsem_up(sem->binary_semaphore1);
 8f8:	4088                	lw	a0,0(s1)
 8fa:	00000097          	auipc	ra,0x0
 8fe:	ac4080e7          	jalr	-1340(ra) # 3be <bsem_up>
}
 ...
 912:	ab0080e7          	jalr	-1360(ra) # 3be <bsem_up>
 916:	b7cd                	j	8f8 <csem_down+0x2e>

0000000000000918 <csem_up>:
...
void csem_up(struct counting_semaphore *sem){
 ...
 92a:	a90080e7          	jalr	-1392(ra) # 3b6 <bsem_down>
    sem->value++;
 92e:	449c                	lw	a5,8(s1)
 ...
 936:	c49c                	sw	a5,8(s1)
    if(sem->value == 1)
 938:	4785                	li	a5,1
 93a:	00f70c63          	beq	a4,a5,952 <csem_up+0x3a>
        bsem_up(sem->binary_semaphore2);
    bsem_up(sem->binary_semaphore1);
 93e:	4088                	lw	a0,0(s1)
 940:	00000097          	auipc	ra,0x0
 944:	a7e080e7          	jalr	-1410(ra) # 3be <bsem_up>
 ...
 958:	a6a080e7          	jalr	-1430(ra) # 3be <bsem_up>
 95c:	b7cd                	j	93e <csem_up+0x26>
