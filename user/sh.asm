...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	44858593          	addi	a1,a1,1096 # 1458 <csem_up+0x4c>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	40258593          	addi	a1,a1,1026 # 1460 <csem_up+0x54>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	3d050513          	addi	a0,a0,976 # 1468 <csem_up+0x5c>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	4a470713          	addi	a4,a4,1188 # 1568 <csem_up+0x15c>
    ...
    panic("runcmd");
      ...
      e2:	39250513          	addi	a0,a0,914 # 1470 <csem_up+0x64>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	37858593          	addi	a1,a1,888 # 1478 <csem_up+0x6c>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	33c58593          	addi	a1,a1,828 # 1488 <csem_up+0x7c>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	2b650513          	addi	a0,a0,694 # 1498 <csem_up+0x8c>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	f1eb8b93          	addi	s7,s7,-226 # 14c0 <csem_up+0xb4>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	eec50513          	addi	a0,a0,-276 # 14a0 <csem_up+0x94>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	e2c60613          	addi	a2,a2,-468 # 14c8 <csem_up+0xbc>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	e1cb0b13          	addi	s6,s6,-484 # 14e8 <csem_up+0xdc>
  ...
  return ret;
     ...
     70a:	dca50513          	addi	a0,a0,-566 # 14d0 <csem_up+0xc4>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	d7050513          	addi	a0,a0,-656 # 14d8 <csem_up+0xcc>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	d4e60613          	addi	a2,a2,-690 # 14f0 <csem_up+0xe4>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	ce6a0a13          	addi	s4,s4,-794 # 14f8 <csem_up+0xec>
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	cb860613          	addi	a2,a2,-840 # 1500 <csem_up+0xf4>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	c1a60613          	addi	a2,a2,-998 # 14c8 <csem_up+0xbc>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	c3a60613          	addi	a2,a2,-966 # 1518 <csem_up+0x10c>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	be850513          	addi	a0,a0,-1048 # 1508 <csem_up+0xfc>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	bf050513          	addi	a0,a0,-1040 # 1520 <csem_up+0x114>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	c2470713          	addi	a4,a4,-988 # 1580 <csem_up+0x174>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	b3060613          	addi	a2,a2,-1232 # 1538 <csem_up+0x12c>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	b0258593          	addi	a1,a1,-1278 # 1540 <csem_up+0x134>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	71e080e7          	jalr	1822(ra) # 1166 <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	a8050513          	addi	a0,a0,-1408 # 14d0 <csem_up+0xc4>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	ade48493          	addi	s1,s1,-1314 # 1550 <csem_up+0x144>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     ab4:	aa8a8a93          	addi	s5,s5,-1368 # 1558 <csem_up+0x14c>
...
0000000000000e7a <kthread_create>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f04:	6a050513          	addi	a0,a0,1696 # 15a0 <digits>
     f08:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1110:	48c90913          	addi	s2,s2,1164 # 1598 <csem_up+0x18c>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11d8:	3f47b783          	ld	a5,1012(a5) # 15c8 <freep>
    ...
    1206:	00e6ea63          	bltu	a3,a4,121a <free+0x50>
{
  ...
  freep = p;
    ...
    1248:	38f73223          	sd	a5,900(a4) # 15c8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    127a:	35253503          	ld	a0,850(a0) # 15c8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12a2:	32a90913          	addi	s2,s2,810 # 15c8 <freep>
  if(p == (char*)-1)
    12a6:	5afd                	li	s5,-1
    12a8:	a895                	j	131c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    12aa:	00000797          	auipc	a5,0x0
    12ae:	38e78793          	addi	a5,a5,910 # 1638 <base>
    12b2:	00000717          	auipc	a4,0x0
    12b6:	30f73b23          	sd	a5,790(a4) # 15c8 <freep>
    ...
    12de:	2ea73723          	sd	a0,750(a4) # 15c8 <freep>
      return (void*)(p + 1);
...
int csem_alloc(struct counting_semaphore *sem, int initial_value){
    ...
    1340:	e04a                	sd	s2,0(sp)
    1342:	1000                	addi	s0,sp,32
    1344:	84aa                	mv	s1,a0
    1346:	892e                	mv	s2,a1
    sem->binary_semaphore1 = bsem_alloc();
    1348:	00000097          	auipc	ra,0x0
    134c:	b52080e7          	jalr	-1198(ra) # e9a <bsem_alloc>
    1350:	c088                	sw	a0,0(s1)
    sem->binary_semaphore2 = bsem_alloc();
    1352:	00000097          	auipc	ra,0x0
    1356:	b48080e7          	jalr	-1208(ra) # e9a <bsem_alloc>
    135a:	87aa                	mv	a5,a0
    135c:	c0c8                	sw	a0,4(s1)
    if(sem->binary_semaphore1 == -1 || sem->binary_semaphore2 == -1)
    135e:	4088                	lw	a0,0(s1)
    1360:	577d                	li	a4,-1
    1362:	00e50963          	beq	a0,a4,1374 <csem_alloc+0x3c>
    1366:	02e78363          	beq	a5,a4,138c <csem_alloc+0x54>
        return -1;
    if(initial_value == 0)
    136a:	00090b63          	beqz	s2,1380 <csem_alloc+0x48>
        bsem_down(sem->binary_semaphore2);
    sem->value = initial_value;
    136e:	0124a423          	sw	s2,8(s1)
    return 0;
    1372:	4501                	li	a0,0
}
    1374:	60e2                	ld	ra,24(sp)
    1376:	6442                	ld	s0,16(sp)
    1378:	64a2                	ld	s1,8(sp)
    137a:	6902                	ld	s2,0(sp)
    137c:	6105                	addi	sp,sp,32
    137e:	8082                	ret
        bsem_down(sem->binary_semaphore2);
    1380:	853e                	mv	a0,a5
    1382:	00000097          	auipc	ra,0x0
    1386:	b28080e7          	jalr	-1240(ra) # eaa <bsem_down>
    138a:	b7d5                	j	136e <csem_alloc+0x36>
        return -1;
    138c:	853e                	mv	a0,a5
    138e:	b7dd                	j	1374 <csem_alloc+0x3c>

0000000000001390 <csem_free>:
...
void csem_free(struct counting_semaphore *sem){
    ...
    139c:	4108                	lw	a0,0(a0)
    139e:	00000097          	auipc	ra,0x0
    13a2:	b04080e7          	jalr	-1276(ra) # ea2 <bsem_free>
    bsem_free(sem->binary_semaphore2);
    13a6:	40c8                	lw	a0,4(s1)
    13a8:	00000097          	auipc	ra,0x0
    13ac:	afa080e7          	jalr	-1286(ra) # ea2 <bsem_free>
    sem->value = 0;
    13b0:	0004a423          	sw	zero,8(s1)
}
    13b4:	60e2                	ld	ra,24(sp)
    13b6:	6442                	ld	s0,16(sp)
    13b8:	64a2                	ld	s1,8(sp)
    13ba:	6105                	addi	sp,sp,32
    13bc:	8082                	ret

00000000000013be <csem_down>:
...
void csem_down(struct counting_semaphore *sem){
    ...
    13c8:	84aa                	mv	s1,a0
    bsem_down(sem->binary_semaphore2);
    13ca:	4148                	lw	a0,4(a0)
    13cc:	00000097          	auipc	ra,0x0
    13d0:	ade080e7          	jalr	-1314(ra) # eaa <bsem_down>
    bsem_down(sem->binary_semaphore1);
    13d4:	4088                	lw	a0,0(s1)
    13d6:	00000097          	auipc	ra,0x0
    13da:	ad4080e7          	jalr	-1324(ra) # eaa <bsem_down>
    sem->value--;
    13de:	449c                	lw	a5,8(s1)
    13e0:	37fd                	addiw	a5,a5,-1
    13e2:	0007871b          	sext.w	a4,a5
    13e6:	c49c                	sw	a5,8(s1)
    if(sem->value > 0)
    13e8:	00e04c63          	bgtz	a4,1400 <csem_down+0x42>
        bsem_up(sem->binary_semaphore2);
    bsem_up(sem->binary_semaphore1);
    13ec:	4088                	lw	a0,0(s1)
    13ee:	00000097          	auipc	ra,0x0
    13f2:	ac4080e7          	jalr	-1340(ra) # eb2 <bsem_up>
}
    13f6:	60e2                	ld	ra,24(sp)
    13f8:	6442                	ld	s0,16(sp)
    13fa:	64a2                	ld	s1,8(sp)
    13fc:	6105                	addi	sp,sp,32
    13fe:	8082                	ret
        bsem_up(sem->binary_semaphore2);
    1400:	40c8                	lw	a0,4(s1)
    1402:	00000097          	auipc	ra,0x0
    1406:	ab0080e7          	jalr	-1360(ra) # eb2 <bsem_up>
    140a:	b7cd                	j	13ec <csem_down+0x2e>

000000000000140c <csem_up>:
...
void csem_up(struct counting_semaphore *sem){
    ...
    1416:	84aa                	mv	s1,a0
    bsem_down(sem->binary_semaphore1);
    1418:	4108                	lw	a0,0(a0)
    141a:	00000097          	auipc	ra,0x0
    141e:	a90080e7          	jalr	-1392(ra) # eaa <bsem_down>
    sem->value++;
    1422:	449c                	lw	a5,8(s1)
    1424:	2785                	addiw	a5,a5,1
    1426:	0007871b          	sext.w	a4,a5
    142a:	c49c                	sw	a5,8(s1)
    if(sem->value == 1)
    142c:	4785                	li	a5,1
    142e:	00f70c63          	beq	a4,a5,1446 <csem_up+0x3a>
        bsem_up(sem->binary_semaphore2);
    bsem_up(sem->binary_semaphore1);
    1432:	4088                	lw	a0,0(s1)
    1434:	00000097          	auipc	ra,0x0
    1438:	a7e080e7          	jalr	-1410(ra) # eb2 <bsem_up>
    143c:	60e2                	ld	ra,24(sp)
    143e:	6442                	ld	s0,16(sp)
    1440:	64a2                	ld	s1,8(sp)
    1442:	6105                	addi	sp,sp,32
    1444:	8082                	ret
        bsem_up(sem->binary_semaphore2);
    1446:	40c8                	lw	a0,4(s1)
    1448:	00000097          	auipc	ra,0x0
    144c:	a6a080e7          	jalr	-1430(ra) # eb2 <bsem_up>
    1450:	b7cd                	j	1432 <csem_up+0x26>
