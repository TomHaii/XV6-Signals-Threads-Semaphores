...
00000000000001de <main>:
{
 ...
 252:	95258593          	addi	a1,a1,-1710 # ba0 <csem_up+0x4a>
 256:	4509                	li	a0,2
 ...
 288:	93c50513          	addi	a0,a0,-1732 # bc0 <csem_up+0x6a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 64e:	59650513          	addi	a0,a0,1430 # be0 <digits>
 652:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 85a:	38290913          	addi	s2,s2,898 # bd8 <csem_up+0x82>
        while(*s != 0){
...
free(void *ap)
{
 ...
 922:	2da7b783          	ld	a5,730(a5) # bf8 <freep>
 ...
 950:	00e6ea63          	bltu	a3,a4,964 <free+0x50>
{
 ...
 992:	26f73523          	sd	a5,618(a4) # bf8 <freep>
}
 996:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9c4:	23853503          	ld	a0,568(a0) # bf8 <freep>
 ...
 9ec:	21090913          	addi	s2,s2,528 # bf8 <freep>
  if(p == (char*)-1)
 9f0:	5afd                	li	s5,-1
 9f2:	a895                	j	a66 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 9f4:	00000797          	auipc	a5,0x0
 9f8:	60c78793          	addi	a5,a5,1548 # 1000 <base>
 9fc:	00000717          	auipc	a4,0x0
 a00:	1ef73e23          	sd	a5,508(a4) # bf8 <freep>
 a04:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a28:	1ca73a23          	sd	a0,468(a4) # bf8 <freep>
      return (void*)(p + 1);
...
int csem_alloc(struct counting_semaphore *sem, int initial_value){
 ...
 a96:	b52080e7          	jalr	-1198(ra) # 5e4 <bsem_alloc>
 a9a:	c088                	sw	a0,0(s1)
    sem->binary_semaphore2 = bsem_alloc();
 a9c:	00000097          	auipc	ra,0x0
 aa0:	b48080e7          	jalr	-1208(ra) # 5e4 <bsem_alloc>
 aa4:	87aa                	mv	a5,a0
 aa6:	c0c8                	sw	a0,4(s1)
    if(sem->binary_semaphore1 == -1 || sem->binary_semaphore2 == -1)
 aa8:	4088                	lw	a0,0(s1)
 aaa:	577d                	li	a4,-1
 aac:	00e50963          	beq	a0,a4,abe <csem_alloc+0x3c>
 ab0:	02e78363          	beq	a5,a4,ad6 <csem_alloc+0x54>
        return -1;
    if(initial_value == 0)
 ab4:	00090b63          	beqz	s2,aca <csem_alloc+0x48>
        bsem_down(sem->binary_semaphore2);
    sem->value = initial_value;
 ab8:	0124a423          	sw	s2,8(s1)
    return 0;
 abc:	4501                	li	a0,0
}
 ...
 ad0:	b28080e7          	jalr	-1240(ra) # 5f4 <bsem_down>
 ad4:	b7d5                	j	ab8 <csem_alloc+0x36>
        return -1;
 ad6:	853e                	mv	a0,a5
 ad8:	b7dd                	j	abe <csem_alloc+0x3c>

0000000000000ada <csem_free>:
...
void csem_free(struct counting_semaphore *sem){
 ...
 aec:	b04080e7          	jalr	-1276(ra) # 5ec <bsem_free>
    bsem_free(sem->binary_semaphore2);
 af0:	40c8                	lw	a0,4(s1)
 af2:	00000097          	auipc	ra,0x0
 af6:	afa080e7          	jalr	-1286(ra) # 5ec <bsem_free>
    sem->value = 0;
 afa:	0004a423          	sw	zero,8(s1)
}
...
void csem_down(struct counting_semaphore *sem){
 ...
 b1a:	ade080e7          	jalr	-1314(ra) # 5f4 <bsem_down>
    bsem_down(sem->binary_semaphore1);
 b1e:	4088                	lw	a0,0(s1)
 b20:	00000097          	auipc	ra,0x0
 b24:	ad4080e7          	jalr	-1324(ra) # 5f4 <bsem_down>
    sem->value--;
 b28:	449c                	lw	a5,8(s1)
 b2a:	37fd                	addiw	a5,a5,-1
 b2c:	0007871b          	sext.w	a4,a5
 b30:	c49c                	sw	a5,8(s1)
    if(sem->value > 0)
 b32:	00e04c63          	bgtz	a4,b4a <csem_down+0x42>
        bsem_up(sem->binary_semaphore2);
    bsem_up(sem->binary_semaphore1);
 b36:	4088                	lw	a0,0(s1)
 b38:	00000097          	auipc	ra,0x0
 b3c:	ac4080e7          	jalr	-1340(ra) # 5fc <bsem_up>
}
 ...
 b50:	ab0080e7          	jalr	-1360(ra) # 5fc <bsem_up>
 b54:	b7cd                	j	b36 <csem_down+0x2e>

0000000000000b56 <csem_up>:
...
void csem_up(struct counting_semaphore *sem){
 ...
 b68:	a90080e7          	jalr	-1392(ra) # 5f4 <bsem_down>
    sem->value++;
 b6c:	449c                	lw	a5,8(s1)
 ...
 b74:	c49c                	sw	a5,8(s1)
    if(sem->value == 1)
 b76:	4785                	li	a5,1
 b78:	00f70c63          	beq	a4,a5,b90 <csem_up+0x3a>
        bsem_up(sem->binary_semaphore2);
    bsem_up(sem->binary_semaphore1);
 b7c:	4088                	lw	a0,0(s1)
 b7e:	00000097          	auipc	ra,0x0
 b82:	a7e080e7          	jalr	-1410(ra) # 5fc <bsem_up>
 ...
 b96:	a6a080e7          	jalr	-1430(ra) # 5fc <bsem_up>
 b9a:	b7cd                	j	b7c <csem_up+0x26>
